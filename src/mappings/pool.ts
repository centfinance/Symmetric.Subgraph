  ...
  if (poolTokenIn != null)
  {
    ...
    if (poolTokenOut != null)
    {
      ...
      if (pool != null)
      {
        ...
        let tokenInSym = poolTokenIn.symbol
        swap.tokenInSym = tokenInSym ? tokenInSym : "";

        swap.tokenOut = event.params.tokenOut
        
        let tokenOutSym = poolTokenOut.symbol
        swap.tokenOutSym = tokenOutSym ? tokenOutSym : "";
